...
MIDDLEWARE = [
    ...
    'config.middleware.NoCacheMiddleware',  # Add this line
]
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {'NAME': 'school.validators.ComplexPasswordValidator'},
]
...
LOGIN_ATTEMPT_LOCKOUT_MINUTES = config('LOGIN_ATTEMPT_LOCKOUT_MINUTES', default=15, cast=int)
...
CORS_ALLOWED_ORIGINS = [
    "https://trilliumschool.in",
    "https://www.trilliumschool.in",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
